...
@pytest.mark.slow
def test_mtq_w_rw_stop_rotation(verbose: bool = False, tf: float = 1000, dt: float = 10, real_orbit: bool = False) -> Union[np.ndarray, np.ndarray, List[Orbital_State], np.ndarray, np.ndarray]:
    np.random.seed(1)
    t0 = 0
    N = int((tf-t0)/dt)
    ...
    # Controller
    controller = MTQ_w_RW(est_sat=real_sat, p_gain=0, d_gain=1, c_gain=0.0, h_target=np.array([0, 0, 0]))
...
@pytest.mark.slow
def test_mtq_w_rw_align(verbose: bool = False, tf: float = 1000, dt: float = 10, real_orbit: bool = False) -> Union[np.ndarray, np.ndarray, List[Orbital_State], np.ndarray, np.ndarray]:
    np.random.seed(1)
    t0 = 0
    N = int((tf-t0)/dt)
...
@pytest.mark.slow
def test_mtq_w_rw_complex_align(verbose: bool = False, tf: float = 1000, dt: float = 10, real_orbit: bool = False) -> Union[np.ndarray, np.ndarray, List[Orbital_State], np.ndarray, np.ndarray]:
    np.random.seed(1)
    t0 = 0
    N = int((tf-t0)/dt)
...
@pytest.mark.slow
def test_mtq_w_rw_desaturate(verbose: bool = False, tf: float = 1000, dt: float = 10, real_orbit: bool = False) -> Union[np.ndarray, np.ndarray, List[Orbital_State], np.ndarray, np.ndarray]:
    np.random.seed(1)
    t0 = 0
    N = int((tf-t0)/dt)
    ...
    # Controller
    controller = MTQ_w_RW(est_sat=real_sat, p_gain=0.0, d_gain=0.0, c_gain=0.01, h_target=np.array([0, 0, 0]))
...
@pytest.mark.slow
def test_mtq_w_rw_full(verbose: bool = False, tf: float = 1000, dt: float = 10, real_orbit: bool = False) -> Union[np.ndarray, np.ndarray, List[Orbital_State], np.ndarray, np.ndarray]:
    np.random.seed(1)
    t0 = 0
    N = int((tf-t0)/dt)
...
def plot_mtq_w_rw_stop_rotation(verbose: bool = False, tf: float = 1000, dt: float = 10, real_orbit: bool = False) -> None:
    (time_hist, state_hist, os_hist, sensor_hist, u_hist) = test_mtq_w_rw_stop_rotation(verbose=verbose, tf=tf, dt=dt, real_orbit=real_orbit)
...
def plot_mtq_w_rw_align(verbose: bool = False, tf: float = 1000, dt: float = 10, real_orbit: bool = False) -> None:
    (time_hist, state_hist, os_hist, sensor_hist, u_hist) = test_mtq_w_rw_align(verbose=verbose, tf=tf, dt=dt, real_orbit=real_orbit)
...
def plot_mtq_w_rw_complex_align(verbose: bool = False, tf: float = 1000, dt: float = 10, real_orbit: bool = False) -> None:
    (time_hist, state_hist, os_hist, sensor_hist, u_hist) = test_mtq_w_rw_complex_align(verbose=verbose, tf=tf, dt=dt, real_orbit=real_orbit)
...
def plot_mtq_w_rw_desaturate(verbose: bool = False, tf: float = 1000, dt: float = 10, real_orbit: bool = False) -> None:
    (time_hist, state_hist, os_hist, sensor_hist, u_hist) = test_mtq_w_rw_desaturate(verbose=verbose, tf=tf, dt=dt, real_orbit=real_orbit)
...
def plot_mtq_w_rw_full(verbose: bool = False, tf: float = 1000, dt: float = 10, real_orbit: bool = False) -> None:
    (time_hist, state_hist, os_hist, sensor_hist, u_hist) = test_mtq_w_rw_full(verbose=verbose, tf=tf, dt=dt, real_orbit=real_orbit)
