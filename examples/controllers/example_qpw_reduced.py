...
x_0 = ADCS.State.from_array(np.array([0.01, 0.05, 0] + [1, 0, 0, 0] + [0])) # w, q, h

controller = ADCS.controller.MTQ_w_RW_QPW(est_sat=real_sat, p_gain=0.00005, d_gain=0.001, c_gain=0.001, h_target=np.zeros(3))
