...
if __name__ == "__main__":
    ...
    if RUN_MC:
        ...
        plot_target_tracking_mc(full_results=full_results, title="3 MTQ + 3 RW MTQ_w_RW_LP MC:100")
        plot_convergence_histogram_mc(full_results=full_results, title="3 MTQ + 3 RW MTQ_w_RW_LP")
