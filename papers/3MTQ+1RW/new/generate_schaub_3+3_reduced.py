...
controller = ADCS.controller.MTQ_w_RW(est_sat=real_sat, p_gain=0.0002, d_gain=0.004, c_gain=0.1, h_target=np.array([0, 0, 0]))
...
mc_config = ADCS.MCConfig(
    ...
    h = lambda rng: rng.uniform(-0.0001, 0.0001, size=3),
