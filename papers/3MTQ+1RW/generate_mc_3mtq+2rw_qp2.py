...
if __name__ == "__main__":
    ...
    if RUN_MC:
        ...
        save_data("3MTQ+2RW_QP2_mc_100", full_results, out_dir=OUTPUT_DIR)
        
        plot_target_tracking_mc(full_results=full_results, title="3 MTQ + 2 RW QP2 MC:100")
        plot_convergence_histogram_mc(full_results=full_results, title="3 MTQ + 2 RW QP2 MC:100")
