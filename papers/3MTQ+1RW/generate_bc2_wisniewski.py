...
if __name__ == "__main__":
    ...
    if RUN_MC:
        ...
        save_data("3MTQ+1RW_Wisniewski_mc_100_4000s", full_results, out_dir=OUTPUT_DIR)

        plot_target_tracking_mc(full_results=full_results, body_boresight=np.array([0, 1, 0]), title="3 MTQ + 1 RW Wisniewski MC:12")
        plot_convergence_histogram_mc(full_results=full_results, body_boresight=np.array([0, 1, 0]), title="3 MTQ + 1 RW Wisniewski")
