...
if __name__ == "__main__":
    ...
    if RUN_MC:
        ...
        plot_target_tracking_mc(full_results=full_results, title="3 MTQ + 1 RW Wisniewski MC:12")
        plot_convergence_histogram_mc(full_results=full_results, title="3 MTQ + 1 RW Wisniewski")
