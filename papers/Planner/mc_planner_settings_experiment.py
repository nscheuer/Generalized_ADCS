...
def apply_fast_slew_tuning(settings, verbose: bool = False):
    ...
    settings.cost_second.ang_vel_mag = 100.0
    settings.cost_second.ang_vel_mag_N = 100.0
    ...
    settings.pass1.regularization.reg_bump =  1e1
    settings.pass2.regularization.reg_bump =  1e1
    ...
    settings.pass2.convergence.z_count_lim = 5  # Exit early when stuck (warm-start is already good)
