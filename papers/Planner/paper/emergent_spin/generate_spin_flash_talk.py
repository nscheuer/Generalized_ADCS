...
Flash-talk slide 3 -- the two stage-weight panels of the emergent-spin demo.
    ...
    Same single open-loop SALTRO solve as the emergent-spin figure generator
    (`generate_emergent_spin.py`, whose
...
def load_p22():
    """Import the emergent-spin generator by path."""
    path = os.path.join(HERE, "generate_emergent_spin.py")
...
def main():
    ...
    npz_path = os.path.join(HERE, "outputs", "spin_traj_flashtalk.npz")
    fig_dir = os.path.join(HERE, "outputs", "flash_talk")
