"""
Quick MC test with normalized settings (scale normalization enabled).
"""
import sys
import os
import time
...
from ADCS.controller.helpers.normalized_settings import NormalizedPlannerConfig, PlannerPresets
...
print(f"\n=== Summary ({NUM_RUNS} runs) - Normalized Preset ===")
