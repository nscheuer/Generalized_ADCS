...
if __name__ == "__main__":
    ...
    if TEST_MODE:
        ...
        plot_single_run(result, body_boresight=BODY_BORESIGHT, title_prefix="3MTQ+1RW LP Full Test")
        ...
        # Plot MC summary
        plot_mc_summary(full_results, body_boresight=BODY_BORESIGHT, title_prefix="3MTQ+1RW LP Full")
        create_close_all_button_window()
        import matplotlib.pyplot as plt
        plt.show()
    else:
