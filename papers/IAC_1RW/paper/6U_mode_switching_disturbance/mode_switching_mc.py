"""Run and plot a 100-run disturbed 6U mode-switching Monte Carlo campaign."""
...
CAMPAIGN_PREFIX = "6u_mode_switching_disturbance_mc"
DT_S = 5.0
DESAT_ENTRY = 0.75
DESAT_EXIT = 0.25
...
def main() -> None:
    ...
    campaign_name = f"{CAMPAIGN_PREFIX}_{args.runs}_1000min"
    ...
    # Plot one selected run while using all runs for the population-fraction bars.
