...
def _worker(config):
    ...
    # trials in flight, not the cell (a stalled pool otherwise holds every finished
    # trial in the parent's memory, unreachable behind the stuck solves).
...
def main() -> int:
    ...
    for cell in cells:
        ...
        if todo:
            ...
            # C++ solver (2 s -> 300 s wall-kills on previously-clean draws) -- recycling
            # removes the mechanism by construction.
