...
if __name__ == "__main__":
    ...
    if RUN_MC:
        ...
        save_data("0MTQ+3RW_LP_mc_100", full_results, out_dir=OUTPUT_DIR)

        plot_target_tracking_mc(full_results=full_results, title="0 MTQ + 3 RW LP MC:100")
        plot_convergence_histogram_mc(full_results=full_results, title="0 MTQ + 3 RW LP MC:100")
