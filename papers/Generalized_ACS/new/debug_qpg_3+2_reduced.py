...
controller = ADCS.controller.MTQ_w_RW_QPG(est_sat=real_sat, p_gain=0.00005, d_gain=0.001, gamma=100, c_gain=0.001, h_target=np.array([0.004, 0.0, 0.0]))
