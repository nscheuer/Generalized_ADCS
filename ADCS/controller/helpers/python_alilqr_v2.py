...
class PythonALILQRv2:
    ...
    def optimize(
        ...
        if use_infeasible and hasattr(self.planner, 'initSlackVariables'):
            ...
            self.planner.setSlackMu(max(200.0, pen_init / pen_scale))
        ...
        # C++ alilqr adds slack cost to LA when infeasible start is active
        ...
        for j in range(max_outer_iter):
            ...
            lam_max = auglag_settings[1]  # lagMultMax
            mu_max = auglag_settings[3]   # penMax
            mu_scale = auglag_settings[4] # penScale
