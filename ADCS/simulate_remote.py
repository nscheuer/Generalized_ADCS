...
def simulate_remote(
    ...
    *,
    ...
    if remote.estimator != ComponentLocation.LOCAL:
        raise NotImplementedError("Remote attitude-estimator execution is not implemented yet.")
    if remote.orbit_estimator != ComponentLocation.LOCAL:
        raise NotImplementedError("Remote orbit-estimator execution is not implemented yet.")
    ...
    if remote.controller == ComponentLocation.REMOTE:
        ...
        try:
            ...
            raise ConnectionError(
                ...
                "Start debug/debug_remote/run_remote_mtq_w_rw_lp_server.py on the remote host, "
