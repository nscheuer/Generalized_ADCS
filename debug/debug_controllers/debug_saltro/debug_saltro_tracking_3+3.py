"""
Track and compare open-loop vs closed-loop SALTRO control for 3+3 (quaternion goal).
"""
import sys
import os
...
# Dynamic import of debug_saltro_3+3 (module name contains +)
debug_module_path = os.path.join(current_dir, "debug_saltro_3+3.py")
spec = importlib.util.spec_from_file_location("debug_saltro_3_3", debug_module_path)
...
def plot_comparison(
    ...
    """Plot open-loop and closed-loop results for 3+3 quaternion goal."""
    ...
    fig.suptitle("SALTRO 3+3 Tracking: Open-Loop vs Closed-Loop (Quaternion Goal)", 
...
if __name__ == "__main__":
    plot_comparison(verbose=True, tf=400.0, dt=10.0, closed_loop_dt=1.0, real_orbit=True)
