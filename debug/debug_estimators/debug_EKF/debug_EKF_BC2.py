"""Run a BeaverCube-2 attitude-estimation scenario with the additive EKF."""
...
def main() -> None:
    ...
    x_0 = ADCS.State(
        w=np.array([-0.00874868, 0.00209214, 0.00593677]),
    ...
    x_hat = ADCS.EstimatorState(
        ...
        q=[1.0, 0.0, 0.0, 0.0],
        h=np.array([rw_h0]),
        cov=np.diag([0.01**2, 0.01**2, 0.01**2, 0.0, 1.0, 1.0, 1.0, 1.0e-6]),
    ...
    ADCS.plot(
        ...
        layout=(1, 1),
        title="EKF Estimator: BeaverCube-2",
    )
