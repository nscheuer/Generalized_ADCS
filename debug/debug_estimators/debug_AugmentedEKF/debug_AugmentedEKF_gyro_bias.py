"""End-to-end AugmentedEKF simulation with estimable gyro biases."""
...
def main() -> None:
    ...
    x_hat = ADCS.EstimatorState(
        # The additive EKF tracks about a coarse attitude solution. Its
        # first-order measurement model is not an initial-acquisition method.
    ...
    ADCS.plot(results, ADCS.plots.AttitudePlot(sources=["real", "estimated"]),
              layout=(1, 1), title="Augmented EKF: Gyro-Bias Estimation")
    ADCS.plot(
        results,
