"""Run a no-bias end-to-end simulation with the augmented additive EKF."""
...
def main() -> None:
    ...
    # Truth spacecraft. No hardware biases are configured in this first case.
    ...
    # Estimated spacecraft: all bias and disturbance-parameter estimation is
    # disabled for this first end-to-end compatibility scenario.
    ...
    ADCS.plot(
        ...
        layout=(1, 1),
        title="Augmented EKF Estimator: No Biases",
    )
    ADCS.plot(
        results,
        ...
        layout=(2, 2),
        title="Augmented EKF Estimator: Gyro + MTM + SunPair",
    )
    run = results.first()
