...
// (B_field, R_eci, prop_torq_on, V_eci, sun_vec, dist_on, rho)
#define DYNAMICS_INFO_PY_FORM_TINY std::tuple<py::array_t<double>, py::array_t<double>, int, py::array_t<double>, py::array_t<double>, int, double>
